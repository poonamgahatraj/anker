...
export default function Bargraph2() {
    const data = {
        ...
        datasets: [
            {
                label: '2022',
                data: [100, 40, 50, 250], // Corresponding Y-axis values for the first bar
                backgroundColor: '#577FBD', // Color for the first bar
                barThickness: 30,
            },
            {
                label: '2023',
                data: [160, 200, 20, 100], // Corresponding Y-axis values for the second bar
    ...
    const options = {
        ...
        scales: {
            x: {
                ...
                categoryPercentage: 0.7, // Adjust this value for more or less gap (default is 1.0)
                barPercentage: 0.8, // A
            },
            y: {
